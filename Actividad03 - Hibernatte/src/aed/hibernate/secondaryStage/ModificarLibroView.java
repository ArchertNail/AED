...
public class ModificarLibroView extends VBox{
	...
	private Button guardarBtn, cerrarBtn, masBtn,menosBtn;
	...
	public ModificarLibroView(){
		...
		HBox botones = new HBox(5,guardarBtn,cerrarBtn);
	...
	public void setGuardarBtn(Button anadirBtn) {
		this.guardarBtn = anadirBtn;
	}
